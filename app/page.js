    ...
    return (
        <>
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        <div className="flex justify-center gap-4">
                            <a
                                href="/about"
                                className="px-6 py-3 bg-green-600 text-white rounded-lg hover:bg-green-600 hover:shadow-[0_4px_12px_rgba(147,51,234,0.25)] transition-all duration-500"
                            >
                                關於本站
                            </a>
                            <a
            ...
            <section className="py-16 bg-gray-50">
                <div className="container mx-auto px-4">
                    <h2 className="text-3xl font-bold mb-12 text-green-800 text-center">
                        作品專區
                    </h2>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 max-w-7xl mx-auto">
                        <div className="bg-white rounded-lg shadow-[0_4px_12px_rgba(147,51,234,0.1)] hover:shadow-[0_6px_16px_rgba(147,51,234,0.2)] transition-shadow duration-300 overflow-hidden">
                            <img 
                            ...
                            />
                            <div className="p-6">
                                <h3 className="text-xl font-bold mb-2 text-green-800">創意教學課程</h3>
                        ...
                        <div className="bg-white rounded-lg shadow-[0_4px_12px_rgba(147,51,234,0.1)] hover:shadow-[0_6px_16px_rgba(147,51,234,0.2)] transition-shadow duration-300 overflow-hidden">
                            ...
                            />
                            <div className="p-6">
                                <h3 className="text-xl font-bold mb-2 text-green-800">教學資源分享</h3>
                                <div className="flex gap-2 mb-3">
                        ...
                        <div className="bg-white rounded-lg shadow-[0_4px_12px_rgba(147,51,234,0.1)] hover:shadow-[0_6px_16px_rgba(147,51,234,0.2)] transition-shadow duration-300 overflow-hidden">
                            ...
                            />
                            <div className="p-6">
                                <h3 className="text-xl font-bold mb-2 text-green-800">專題研究計畫</h3>
                                <div className="flex gap-2 mb-3">
                        ...
                        <div className="bg-white rounded-lg shadow-[0_4px_12px_rgba(147,51,234,0.1)] hover:shadow-[0_6px_16px_rgba(147,51,234,0.2)] transition-shadow duration-300 overflow-hidden">
                            ...
                            />
                            <div className="p-6">
                                <h3 className="text-xl font-bold mb-2 text-green-800">教育工作坊</h3>
                                <div className="flex gap-2 mb-3">
                        ...
                        <div className="bg-white rounded-lg shadow-[0_4px_12px_rgba(147,51,234,0.1)] hover:shadow-[0_6px_16px_rgba(147,51,234,0.2)] transition-shadow duration-300 overflow-hidden">
                            ...
                            />
                            <div className="p-6">
                                <h3 className="text-xl font-bold mb-2 text-green-800">學生作品集</h3>
                                <div className="flex gap-2 mb-3">
                        ...
                        <div className="bg-white rounded-lg shadow-[0_4px_12px_rgba(147,51,234,0.1)] hover:shadow-[0_6px_16px_rgba(147,51,234,0.2)] transition-shadow duration-300 overflow-hidden">
                            ...
                            />
                            <div className="p-6">
                                <h3 className="text-xl font-bold mb-2 text-green-800">教育科技應用</h3>
                                <div className="flex gap-2 mb-3">
